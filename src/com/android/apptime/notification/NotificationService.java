...
public class NotificationService extends Service{
	...
	public void onDestroy() {
		...
		shutdownCounter();
        nm.cancel(R.string.eventreminder);
    ...
    private void showNotification() {
        ...
        CharSequence text = getText(com.android.apptime.R.string.eventreminder);
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, NotificationLauncher.class), 0);

        // Set the info for the views that show in the notification panel.
        String service_label = ""; // modify later
        
        notification.setLatestEventInfo(this, service_label,
                       text, contentIntent);

        // Send the notification.
        // We use a layout id because it is a unique number.  We use it later to cancel.
        nm.notify(R.string.eventreminder, notification);
    }
